            ...
            <form className="register-form" id="register-form" onSubmit={handleSubmit}>
                    <div className="register-form__text-inputs">
                        <div className="register-form__text-input-wrapper">
                            <input className="register-form__text-input" id="username" name="username" type="text" placeholder="Your name" required onKeyUp={(event) => cleanValidationError(event.target.name)} />
                            <label className="register-form__text-input-label" htmlFor="username">Your name</label>
                            {validationErrors.username &&
                                <small className="register-form__error-text">{validationErrors.username}</small>
                            }
                        </div>
                        <div className="register-form__text-input-wrapper">
                            <input className="register-form__text-input" id="email" name="email" type="email" placeholder="Email" required onKeyUp={(event) => cleanValidationError(event.target.name)}/>
                            <label className="register-form__text-input-label" htmlFor="email">Email</label>
                            {validationErrors.email &&
                                <small className="register-form__error-text">{validationErrors.email}</small>
                            }
                        </div>
                        <div className="register-form__text-input-wrapper">
                            <input className="register-form__text-input" id="phone" name="phone" type="tel" placeholder="Phone" required onKeyUp={(event) => cleanValidationError(event.target.name)}/>
                            <label className="register-form__text-input-label" htmlFor="phone">Phone</label>
                        ...
                        {positions &&
                            (positions.map((item, index) => (
                                <div className="register-form__radio-input-wrapper" key={index}>
                                    <input className="register-form__radio-input" name="position" type="radio" id={item.id} value={item.name} required defaultChecked={index === 0}/>
                                    <label className="register-form__radio-input-label" htmlFor={item.name}>{item.name}</label>
                                </div>
                            )
                            ))}
                    </fieldset>
                    <div className="register-form__upload-inputs-wrapper">
                        <label className="register-form__upload-input-label" htmlFor="file-upload">Upload</label>
